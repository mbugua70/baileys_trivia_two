        ...
        <div className={`${Styles.login_container} ${Styles.welcome_screen}`}>
          <div className={Styles.welcome_content}>
            ...
            <div className={Styles.welcome_text}>
              {/* Baileys Logo/Title */}
              <div className={Styles.baileys_logo}>
                <span className={Styles.baileys_text}>BAILEYS</span>
              </div>

              <h1 className='animate__animated animate__fadeInDown animate__slow'>
                <span className={Styles.text_highlight}>Treat Yourself</span>
                <span className={Styles.text_main}>Trivia Challenge</span>
              </h1>

              {/* Venue showcase */}
              <div className={Styles.brands_showcase}>
                <div className={`${Styles.brand_item} ${Styles.brand_yamas} animate__animated animate__fadeInLeft animate__delay-1s`}>
                  <span className={Styles.brand_name}>YAMAS</span>
                  <span className={Styles.brand_subtitle}>Music & Cocktails</span>
                </div>

                <div className={`${Styles.brand_divider} animate__animated animate__fadeIn animate__delay-1s`}>×</div>

                <div className={`${Styles.brand_item} ${Styles.brand_onza} animate__animated animate__fadeInUp animate__delay-1s`}>
                  <span className={Styles.brand_name}>ONZA</span>
                  <span className={Styles.brand_subtitle}>Fine Dining</span>
                </div>

                <div className={`${Styles.brand_divider} animate__animated animate__fadeIn animate__delay-1s`}>×</div>

                <div className={`${Styles.brand_item} ${Styles.brand_rafaelo} animate__animated animate__fadeInRight animate__delay-1s`}>
                  <span className={Styles.brand_name}>RAFAELO</span>
                  <span className={Styles.brand_subtitle}>Coffee & Treats</span>
                </div>
              </div>

              <p className='animate__animated animate__fadeIn animate__delay-2s'>
                Answer fun questions and discover which Baileys experience matches your vibe
              </p>
            </div>
